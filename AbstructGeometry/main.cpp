...
{
	/*
enum (Enumerotor - Перечисление)- это набор именнованых констант типа 'int'
*/
...
#define SHAPE_GIVE_PARAMETERS start_x, start_y, line_width, color
	...
	public:
		...
		void info()const override
		{
			...
			cout << "Диаметр круга: " << get_perimeter() << endl;
			Shape::info();
		}
	};
	...
	public:
		...
		{
			cout << typeid(*this).name() << endl;
			cout << "Основания треугольника: " << get_base() << endl;
...
void main()
{
	...
	Geometry::IsoscelesTriangle iso_triangle(200, 10, 500, 200, 1, Geometry::Color::DARK_GREEN);
	iso_triangle.info();
